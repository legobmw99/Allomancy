...
public class EntityGoldNugget extends Entity implements IProjectile {
    ...
    public EntityGoldNugget(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityGoldNugget(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    public void onUpdate()
    {
        ...
        {
            this.setDead();
            this.entityDropItem(new ItemStack(Item.goldNugget.itemID, 1, 0), 0.0F);
        }
        else
        {
            ++this.ticksInAir;
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (movingobjectposition.entityHit.attackEntityFrom(damagesource, (float)i1))
                    {
                        ...
                        this.playSound("mob.irongolem.throw", 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
