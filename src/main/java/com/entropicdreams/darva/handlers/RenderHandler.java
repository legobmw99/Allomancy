...
public class RenderHandler implements ITickHandler {
	...
	public void tickEnd(EnumSet<TickType> type, Object... tickData) {
		...
		if (AllomancyData.isMistborn == true) {
			...
			TextureObject obj;
			obj = Minecraft.getMinecraft().renderEngine
					.getTexture(this.meterLoc);
			...
			gig.drawTexturedModalRect(6, 20 + ironY, 7, 1 + ironY, 3,
					10 - ironY);
			...
			gig.drawTexturedModalRect(81, 20 + zincY, 43, 1 + zincY, 3,
					10 - zincY);
