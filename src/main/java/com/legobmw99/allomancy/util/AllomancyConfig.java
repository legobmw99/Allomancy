...
public class AllomancyConfig {
    ...
    public static void initProps(File confFile) {
        ...
        generateAluminum = config.get("Worldgen Disabler", "Generate Aluminum Ore", true).getBoolean(true);
        ...
        aluminumMinY = config.get("Worldgen", "Aluminum Min Y", 20).getInt(20);
        aluminumMaxY = config.get("Worldgen", "Aluminum Max Y", 40).getInt(40);
