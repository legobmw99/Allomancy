...
public class ExternalPowerController {
    ...
    public void tryAddMetalEntity(Entity entity) {
        ...
        if (entity instanceof EntityLiving && (((entity instanceof EntityIronGolem) || (((((EntityLiving) entity).getHeldItem(EnumHand.MAIN_HAND) != null) || ((EntityLiving) entity).getHeldItem(EnumHand.OFF_HAND) == null)
                && (this.isItemMetal(((EntityLiving) entity).getHeldItem(EnumHand.MAIN_HAND)) || this.isItemMetal(((EntityLiving) entity).getHeldItem(EnumHand.OFF_HAND))))))) {
            this.particleTargets.add(entity);
            return;
        }
        ...
        if (entity instanceof EntityItemFrame && this.isItemMetal(((EntityItemFrame) entity).getDisplayedItem())) {
            this.particleTargets.add(entity);
            return;
        }
    }
