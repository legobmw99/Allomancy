...
public class Network {
    public static void registerPayloads(final RegisterPayloadHandlerEvent event) {
        ...
        registrar.play(AllomancerDataPayload.ID, AllomancerDataPayload::new, handler -> handler.client(ClientPayloadHandler::updateAllomancer));
        registrar.play(EmotionPayload.ID, EmotionPayload::new, handler -> handler.server(ServerPayloadHandler::changeEmotion));
