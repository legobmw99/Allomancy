...
public class MaterialsConfig {
    ...
    public static void init(ForgeConfigSpec.Builder common_builder, ForgeConfigSpec.Builder client_builder) {
        ...
        aluminum_min_y = common_builder.comment("Minimum Y Level to Generate Aluminum").defineInRange("aluminum_min_y", 30, 1, 128);
        aluminum_max_y = common_builder.comment("Maximum Y Level to Generate Aluminum").defineInRange("aluminum_max_y", 50, 1, 128);
        common_builder.pop();
