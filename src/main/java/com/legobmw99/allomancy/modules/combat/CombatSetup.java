...
public class CombatSetup {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITIES =
            DeferredRegister.create(ForgeRegistries.ENTITY_TYPES, Allomancy.MODID);
    ...
    public static final RegistryObject<ObsidianDaggerItem> OBSIDIAN_DAGGER =
            ITEMS.register("obsidian_dagger", ObsidianDaggerItem::new);
    public static final RegistryObject<KolossBladeItem> KOLOSS_BLADE =
    ...
    public static final RegistryObject<EntityType<ProjectileNuggetEntity>> NUGGET_PROJECTILE =
