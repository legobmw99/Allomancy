...
public class AllomancyPackets {
	...
	private static void registerPackets() {
		...
		Allomancy.packetPipeline
				.registerPacket(AllomancySelectMetalPacket.class);
		Allomancy.packetPipeline
				.registerPacket(AllomancyChangeEmotionPacket.class);
		Allomancy.packetPipeline.registerPacket(AllomancyDataPacket.class);
		Allomancy.packetPipeline
				.registerPacket(AllomancyMoveEntityPacket.class);
		Allomancy.packetPipeline
				.registerPacket(AllomancyUpdateBurnPacket.class);
	}
}
