...
public class Registry {
	...
	public static ArmorMaterial WoolArmor = net.minecraftforge.common.util.EnumHelper.addArmorMaterial("Wool", 5, new int[] { 0, 4, 0, 0}, 15);
	...
	public static void setupRecipes() 
	{
		...
		GameRegistry.addShapelessRecipe(new ItemStack(itemIronFlakes, 2),new ItemStack(Items.iron_ingot), new ItemStack(itemAllomancyGrinder, 1,OreDictionary.WILDCARD_VALUE));
		...
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 1),new ItemStack(itemIronFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.water_bucket));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 2),new ItemStack(itemSteelFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.water_bucket));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 3),new ItemStack(itemTinFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.water_bucket));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 4),new ItemStack(itemPewterFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.water_bucket));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 5),new ItemStack(itemZincFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.water_bucket));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 6),new ItemStack(itemBrassFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.water_bucket));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 7),new ItemStack(itemCopperFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.water_bucket));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 8),new ItemStack(itemBronzeFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.water_bucket));
		
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 1),new ItemStack(itemIronFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.potionitem));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 2),new ItemStack(itemSteelFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.potionitem));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 3),new ItemStack(itemTinFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.potionitem));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 4),new ItemStack(itemPewterFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.potionitem));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 5),new ItemStack(itemZincFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.potionitem));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 6),new ItemStack(itemBrassFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.potionitem));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 7),new ItemStack(itemCopperFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.potionitem));
		GameRegistry.addShapelessRecipe(new ItemStack(itemVial, 1, 8),new ItemStack(itemBronzeFlakes), new ItemStack(itemVial, 1, 0),new ItemStack(Items.potionitem));

		GameRegistry.addRecipe(new ItemStack(Mistcloak, 1), new Object[] {"W W", "WWW", "WWW", 'W', new ItemStack(Blocks.wool, 1, 7) });
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemVial, 1, 0), " x ", "y y", " y ", 'x',"slabWood", 'y', Blocks.glass));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(itemAllomancyGrinder, 1, 0), "xxx", "yyy", "xxx", 'x', Items.iron_ingot, 'y', Items.gold_nugget));
		GameRegistry.addRecipe(new ShapelessOreRecipe(new ItemStack(nuggetLerasium), new Object[] {new ItemStack(Blocks.gold_block, 1) , new ItemStack(Items.nether_star, 1)}));
		
	}
	 public static void initBlocks()
	 {
		 oreTin = new OreBlock(Material.field_151576_e, OreType.TIN).func_149663_c("allomancy:tinore");
		 GameRegistry.registerBlock(oreTin, "allomancy:tinore");
		 LanguageRegistry.addName(oreTin, "Tin Ore");
		 
		 oreLead = new OreBlock(Material.field_151576_e, OreType.LEAD).func_149663_c("allomancy:leadore");
		 GameRegistry.registerBlock(oreLead, "allomancy:leadore");
		 LanguageRegistry.addName(oreLead, "Lead Ore");
		 
		 oreCopper = new OreBlock(Material.field_151576_e, OreType.COPPER).func_149663_c("allomancy:copperore");
		 GameRegistry.registerBlock(oreCopper, "allomancy:copperore");
		 LanguageRegistry.addName(oreCopper, "Copper Ore");
		 
		 oreZinc = new OreBlock(Material.field_151576_e, OreType.ZINC).func_149663_c("allomancy:zincore");
	 ...
	 public static void initItems()
	 {
		...
		itemTinIngot = new Item().setUnlocalizedName("allomancy:tiningot").setCreativeTab(CreativeTabs.tabMaterials).setMaxDamage(0);
		...
		itemTinFlakes = new Item().setUnlocalizedName("allomancy:tinflakes").setCreativeTab(Registry.tabsAllomancy);
		...
		itemLeadIngot = new Item().setUnlocalizedName("allomancy:leadingot").setCreativeTab(CreativeTabs.tabMaterials).setMaxDamage(0);
		...
		itemLeadFlakes = new Item().setUnlocalizedName("allomancy:leadflakes").setCreativeTab(Registry.tabsAllomancy);
		...
		itemCopperIngot = new Item().setUnlocalizedName("allomancy:copperingot").setCreativeTab(CreativeTabs.tabMaterials).setMaxDamage(0);
		...
		itemCopperFlakes = new Item().setUnlocalizedName("allomancy:copperflakes").setCreativeTab(Registry.tabsAllomancy);
		...
		itemZincIngot = new Item().setUnlocalizedName("allomancy:zincingot").setCreativeTab(CreativeTabs.tabMaterials).setMaxDamage(0);
		...
		itemZincFlakes = new Item().setUnlocalizedName("allomancy:zincflakes").setCreativeTab(Registry.tabsAllomancy);
		...
		itemIronFlakes = new Item().setUnlocalizedName("allomancy:ironflakes").setCreativeTab(Registry.tabsAllomancy);
		...
		itemSteelFlakes = new Item().setUnlocalizedName("allomancy:steelflakes").setCreativeTab(Registry.tabsAllomancy);
		...
		itemBrassFlakes = new Item().setUnlocalizedName("allomancy:brassflakes").setCreativeTab(Registry.tabsAllomancy);
		...
		itemPewterFlakes = new Item().setUnlocalizedName("allomancy:pewterflakes").setCreativeTab(Registry.tabsAllomancy);
		...
		itemBronzeFlakes = new Item().setUnlocalizedName("allomancy:bronzeflakes").setCreativeTab(Registry.tabsAllomancy);
		...
		Mistcloak = new ItemMistcloak(WoolArmor, 5, 1).setUnlocalizedName("allomancy:mistcloak").setCreativeTab(CreativeTabs.tabCombat);
