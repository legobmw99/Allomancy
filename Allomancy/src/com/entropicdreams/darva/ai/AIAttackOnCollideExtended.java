package com.entropicdreams.darva.ai;
...
public class AIAttackOnCollideExtended extends EntityAIBase {
    ...
    public AIAttackOnCollideExtended(EntityCreature par1EntityCreature, Class par2Class, double par3, boolean par5)
    {
        this(par1EntityCreature, par3, par5);
        this.classTarget = par2Class;
    }

    public AIAttackOnCollideExtended(EntityCreature par1EntityCreature, double par2, boolean par4)
    {
        ...
        if (this.attacker.getDistanceSq(entitylivingbase.posX, entitylivingbase.boundingBox.minY, entitylivingbase.posZ) <= d0)
        {
            if (this.attackTick <= 0)
            {
                ...
                if (this.attacker instanceof EntityAnimal)
                {
                	...
                	entitylivingbase.attackEntityFrom(DamageSource.causeMobDamage(this.attacker), 3);
                }
                else
                {
